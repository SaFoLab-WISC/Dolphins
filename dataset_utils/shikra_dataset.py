...
class ShikraDataset(VQADataset):
...
if __name__ == "__main__":
    ...
    dataset = ShikraDataset(
        ...
        vis_root="/home/scratch.chaoweix_nvresearch/visual_instruction/MultiInstruct/flickr30k",
        ann_paths=[
            "/home/scratch.chaoweix_nvresearch/visual_instruction/Visual-Instrcution-tuning/workspace/dataset/Shikra/shikra_box_cot.jsonl",
        ]
    )
    ...
    for batch in train_dataloader:
        ...
        plt.imshow(image)
        plt.savefig("/home/scratch.chaoweix_nvresearch/visual_instruction/Visual-Instrcution-tuning/examples/llava.png")

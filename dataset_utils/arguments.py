...
def add_data_args(parser=None):
    ...
    group.add_argument("--imagenet-default-mean-and-std",
                       type=bool,
                       default=False)
    group.add_argument(
        "--max-src-length",
    ...
    group.add_argument("--prompt-type",
                       type=str,
                       default=None,
                       help="prompt_type")
    group.add_argument("--add-object",
                       type=bool,
                       default=False,
                       help="add object to encoder")
    group.add_argument("--add-caption",
                       type=bool,
                       default=False,
...
def add_criterions_args(parser):
    ...
    group.add_argument(
        ...
        default="allcand",
        help=
        "inference type in validation (allcand or beamsearch), default to allcand",
    )
    return parser
